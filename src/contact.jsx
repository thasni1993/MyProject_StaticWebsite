      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-4">
              ...
              <img src={contact1} alt="u"></img>
            <a href="tel:9809459729">+91 8593820942</a><br/>
            <img src={contact2} alt="u"></img>&nbsp;&nbsp;
            <a href="tel:8593820942">+91 8593820942</a>
            <br />
            <img src={mail} alt="u"></img>
            <a href="mailto:karannarjun4u@gmail.com">
              karannarjun4u@gmail.com
            </a>
            <br />
            <img src={location} alt="u"></img>
